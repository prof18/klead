package dev.defuddle.internal

import dev.defuddle.DefuddleContent
import dev.defuddle.DefuddleMetadata
import dev.defuddle.DefuddleOptions
import dev.defuddle.DefuddleOutput
import dev.defuddle.DefuddleResult
...
import dev.defuddle.internal.content.ContentDetectionDebug
import dev.defuddle.internal.content.MainContentDetector
import dev.defuddle.internal.dom.cloneDocument
import dev.defuddle.internal.dom.isDangerousUrl
import dev.defuddle.internal.dom.parseFragment
import dev.defuddle.internal.extractors.DefaultExtractors
import dev.defuddle.internal.extractors.ExtractorRegistry
import dev.defuddle.internal.extractors.site.ExtractorRemovalPipeline
import dev.defuddle.internal.markdown.DefuddleMarkdownWriter
import dev.defuddle.internal.metadata.MetadataExtractor
import dev.defuddle.internal.metadata.PageMetadataExtractor
import dev.defuddle.internal.metadata.SchemaOrgResult
import dev.defuddle.internal.removal.RemovalPipeline
import dev.defuddle.internal.removal.RemovalPolicy
import dev.defuddle.internal.standardize.HtmlStandardizer
...
internal object DefuddleParser {
    ...
    ): DefuddleResult = withContext(parserDispatcher) {
    ...
    private fun DefuddleOptions.effectiveExtractors(): List<Extractor> = customExtractors + DefaultExtractors.all
