...
| ![Diagram of cell cycle phases](https://example.com/cell-cycle.png) | Phase G1: cell growth  Phase S: DNA replication  Phase G2: preparation for division  Phase M: mitosis |
| --- | --- |
...
2. Lodish, H. et al. (2012). *Molecular Cell Biology*. 7th edition. New York: W.H. Freeman.
3. Cooper, G.M. (2000). *The Cell: A Molecular Approach*. 2nd edition. Sunderland: Sinauer Associates.
