```json
{
  "title": "I spent months testing the Honor Magic V6, and I'm not sure how foldables can get much better than this",
  "author": "Nicholas Sutrich",
  "site": "Android Central",
  "published": "2026-06-15T09:03:00Z"
}
```
...
It's a foldable phone with a gorgeous, eye-friendly pair of OLEDs, the world's highest-capacity battery in a foldable, a top-end [Snapdragon 8 Elite Gen 5](https://www.androidcentral.com/phones/qualcomm/qualcomm-snapdragon-8-elite-gen-5) processor, amazing software, and cameras that finally don't make me miss using a standard flagship phone. It's the first time I've felt like a foldable phone came with zero compromises, and it's easily the best foldable experience to date.
...
Honor's OLED displays are the best in the business, too, providing not only leading brightness output and 10-bit color reproduction among foldable phones, but also excellent eye care solutions like the [myopia-reducing defocus feature](https://www.androidcentral.com/phones/honor-magicpad-2-honor-magic-v3-ai-defocus-display), as well as user-selectable dimming options up to 4320Hz [PWM dimming](https://www.androidcentral.com/phones/what-is-pwm-display-flicker-tips-and-tricks) for flicker-sensitive people.
...
And while those are annoying complaints, I truly enjoy [Honor's ecosystem of products](https://www.androidcentral.com/phones/sometimes-the-ecosystem-is-more-important-than-the-individual-devices) and how well they work together. I get message and call notifications on my Honor laptop, can easily run my phone's apps on that same machine, quickly transfer files between them, set up a hotspot (that doesn't use my carrier's hotspot data), and more.
...
The Honor Magic V6 has the best camera on any foldable outside of China. If that's all you needed to hear, you can stop here. I've taken over 1,000 photos using this phone [since I received it in March](https://www.androidcentral.com/phones/honor-phones/honor-magic-v6-mwc-hands-on-interview), and am constantly blown away by its quality.
...
I put it head-to-head [against the Motorola Razr Fold's camera](https://www.androidcentral.com/phones/motorola/motorola-razr-fold-camera-review#section-motorola-razr-fold-vs-honor-magic-v6) and found that Honor generally won the competition. However, Motorola's processing tends to do a better job of balancing highlights and shadow detail in more extreme scenes.
...
Are you ready to try the best foldable you've ever used? The Honor Magic V6 blows the competition out of the water with its top-tier processor, battery capacity, camera quality, and displays, plus a durable, thin build that's made to last.
